        ...
        <Card size="sm" className="bg-card/90">
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              MARULHO is not rendering every column when the field gets large. It samples a stable visual subset for speed while the underlying runtime keeps using the full network.
            </p>
          </CardContent>
        </Card>
      </div>
