      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>LLM-powered thought generation via Gemma / Ollama — the neocortex of the living brain.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-3 sm:grid-cols-2">
            <DetailItem label="Enabled" value={brain?.cortex?.enabled ? 'Yes' : 'No'} help="Whether the Cortex (LLM thought loop) is active. Requires Ollama running with a Gemma model." />
